...
export default function LegacySupervisorHeadOfficeView({ storesData }) {
  ...
  return (
    <section className="head-office-view">
      <div className="panel-heading-large">
        ...
        <p className="subtitle">전 가맹점의 실시간 수용 인원 및 대기열 상태를 본사에서 즉시 체크하고 관리합니다.</p>
      </div>

      <section className="alert-banner live-sync-banner" style={{
        ...
        <span className="status-tag active" style={{ fontSize: '12px', padding: '6px 12px' }}>
          ● 본사-매장 실시간 동기화 완료
        </span>
      </section>
      ...
      <div className="head-office-grid">
        <article className="panel store-compare-card">
          ...
          <div className="card-metrics">
            <div className="metric-row">
              <span>현재 실시간 인원</span>
              <strong style={{ color: '#2563eb' }}>{store1State?.visible_person_count ?? 0}명</strong>
            </div>
            <div className="metric-row">
              <span>대기 인원 / ETA</span>
            ...
            <div className="metric-row">
              ...
              <strong>{store1State?.quality_status === "normal" ? "🟢 정상 (Cam 01)" : "🟡 점검 필요 (Cam 01)"}</strong>
            </div>
          </div>
        </article>
        ...
        <article className="panel store-compare-card">
          ...
          <div className="card-metrics">
            <div className="metric-row">
              <span>현재 실시간 인원</span>
              <strong style={{ color: '#2563eb' }}>{store2State?.visible_person_count ?? 0}명</strong>
            </div>
            <div className="metric-row">
              <span>대기 인원 / ETA</span>
            ...
            <div className="metric-row">
              <span>AI 비전 카메라 피드</span>
              <strong>{store2State?.quality_status === "normal" ? "🟢 정상 (Cam 02)" : "🟡 점검 필요 (Cam 02)"}</strong>
            </div>
          </div>
        </article>
      </div>
        ...
        <article className="panel">
          ...
          <div className="policy-list">
            ...
            <div className="policy-item">
              ...
              <p>모든 가맹점의 AI 카메라 피드 및 감지 데이터가 안정적으로 통합 수집 중입니다.</p>
            </div>
          </div>
        </article>
      </div>
